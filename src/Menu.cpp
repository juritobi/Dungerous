...
Menu* Menu::getMenu(){
	...
	Menu::Menu()
	{
        ...
        AssetManager::getAssetManager()->createFont("listFont", "assets/DancingScript-Regular.otf");
...
void Menu::posNuevo(){
	...
	{
        menuList[0].setFont(AssetManager::getAssetManager()->GetFont("listFont"));
        menuList[1].setFont(AssetManager::getAssetManager()->GetFont("listFont"));
